...
class LoginTest(unittest.TestCase):
	...
	def logout(self):
		...
		logout_button = self.driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/X.03C/android.view.ViewGroup[12]/android.view.ViewGroup[2]")
		logout_button.click()
